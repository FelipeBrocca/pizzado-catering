...
const MenuSScreen = () => {
  ...
  return (
    <>
      ...
      <span className="icon-menu" onClick={handlePopUp}>
        <div></div>
        <div></div>
        <div></div>
      </span>
      <nav
        className={`main-nav small ${isClosed ? 'closed' : ''}`}
        id="main-nav"
      >
        <div>
          <p onClick={handlePopUp}>X</p>
        </div>
        <ul className="menu">
          ...
          <li className="menu-item contact">
            <Link className="menu-link" onClick={handleContact}>
              <p>Contacto</p>
              <FontAwesomeIcon
                icon={faChevronDown}
                className={openContact ? 'chevron-active' : 'chevron-unactive'}
              />
            </Link>
            <ul className={openContact ? 'open' : ''}>
              <li>
                <a
